...
# 反射強度の閾値
intensity_threshold_log = np.log(40 + 1)  # 対数スケーリング後の閾値
...
# 点群マップの保存
o3d.io.write_point_cloud("final_point_fun_fffff_after2_cloud.pcd", final_pcd)