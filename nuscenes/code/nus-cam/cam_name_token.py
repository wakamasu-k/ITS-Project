...
extraction_path = 'C:\\Users\\divin\\Downloads\\scene3_sgp\\cam\\cam'  # このパスを実際のフォルダの場所に合わせて変更してください
...
# すべてのsample_tokenを表示
for file_name, sample_token in file_name_to_sample_token.items():
    print(f"{sample_token}")


# 結果をDataFrameに変換し、表示します
#df_tokens = pd.DataFrame(list(file_name_to_sample_token.items()), columns=['File Name', 'Ego Pose Token'])
#print(df_tokens)
