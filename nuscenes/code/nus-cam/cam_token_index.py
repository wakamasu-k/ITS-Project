...
ego_pose_json_path = 'C:\\Users\\divin\\OneDrive - 梅村学園　中京大学\\MD\\卒業研究\\data\\nuScenes mini us\\v1.0-mini\\sample.json'  # Adjust the path as needed

with open(ego_pose_json_path, 'r') as file:
    ego_poses = json.load(file)

# Load the tokens from token.txt
token_txt_path = 'C:\\Users\\divin\\Downloads\\scene3_sgp\\cam\\cam_token.txt'  # Adjust the path as needed
